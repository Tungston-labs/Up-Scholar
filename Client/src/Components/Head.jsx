      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="block md:hidden mt-10">
          <h1 className="text-2xl font-bold text-blue-800 leading-snug">
            One platform. Four global pathways. <br /> Unlimited possibilities.
            <br />
            From careers to capital your  gateway to global opportunity.
          </h1>
        </div>

        <div className="max-w-4xl mt-10 hidden md:block">
          <h1 className="text-3xl md:text-6xl font-extrabold text-blue-800 leading-snug">
            One platform Four global pathways<br /> Unlimited possibilities From<br />
            careers to capital — your <br />gateway to global opportunity.<br />
